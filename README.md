<div align="center">
  <h1>⚖️ AI Legal Intelligence Platform</h1>
  <p><i>A full-stack, AI-powered legal search and RAG (Retrieval-Augmented Generation) system built for Vietnamese Law.</i></p>
...
## 📖 Overview
This project is an advanced **Legal AI Search & Assistant Engine**. It goes beyond simple keyword matching by implementing a **Hybrid Search Pipeline (BM25 + Semantic Search)** and an **anti-hallucination RAG engine** to provide accurate, citable legal answers. Designed with a **Modular Monolith** architecture and a modern **Glassmorphism UI**, this project demonstrates end-to-end full-stack engineering capabilities, from automated ETL pipelines to real-time AI streaming.
...
## 🚀 Key Technical Highlights (Why this project stands out)
...
Utilized `vis-network` to render an interactive Graph UI, allowing users to visually explore legal relationships (e.g., Amendments, Guidelines, References) directly within the document view.
